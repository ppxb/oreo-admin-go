...
type FileWithLineNumbOptions struct {
	skipGorm   bool
	skipHelper bool
}

func WithSkipGorm(flag bool) func(*FileWithLineNumbOptions) {
	return func(options *FileWithLineNumbOptions) {
		getFileWithLineNumOptionsOrSetDefault(options).skipGorm = flag
	}
}

func WithSkipHelper(flag bool) func(*FileWithLineNumbOptions) {
	return func(options *FileWithLineNumbOptions) {
		getFileWithLineNumOptionsOrSetDefault(options).skipHelper = flag
	}
}

func getFileWithLineNumOptionsOrSetDefault(options *FileWithLineNumbOptions) *FileWithLineNumbOptions {
	if options == nil {
		return &FileWithLineNumbOptions{}
	}
	return options
}
